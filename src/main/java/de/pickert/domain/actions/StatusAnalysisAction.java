...
public class StatusAnalysisAction extends Action {
    ...
    public void execute() {
        ...
        // }
        // Iterator<Entry<Status, List<Task>>> statusIterator =
        // mapKeyStatus.entrySet().iterator();
        // while (statusIterator.hasNext()) {
        // Map.Entry<Status, List<Task>> tasksInStatus = statusIterator.next();
        // System.out.println("The following"+tasksInStatus.getValue().size() +" tasks
        // are in Status: "+tasksInStatus.getKey());

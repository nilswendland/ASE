...
import de.pickert.utils.HashMultiMap;
...
public class ResponsibleAnalysisAction extends Action {
    ...
    public void execute() {
        ...
        while (responsibleIterator.hasNext()) {
            ...
            System.out.println(tasksOfResponsible.getKey() + " is responsible for the following "
                    + tasksOfResponsible.getValue().size() + " tasks:");
